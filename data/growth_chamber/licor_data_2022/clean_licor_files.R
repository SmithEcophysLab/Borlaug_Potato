# Script for cleaning LI-6800 raw files from Dinah Borus' 2022 potato 
# greenhouse experiment at TTU. Note that all paths in the first part of 
# this script assume working directory root is the path to this script in the 
# flash drive titled "BP". Path assigned via Apple operating system, may differ 
...
###############################################################################
setwd("../../Volumes/BP/Dinah licor files/")
